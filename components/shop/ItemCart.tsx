...
export const ItemCart = ({onRemove, item}: ItemCartPropsType) => {
    return (
        <View style={styles.container}>
            <AppText style={styles.itemDate}>
                <AppText style={styles.quantity}>{item.quantity}</AppText> <AppText style={styles.title}>{item.title}</AppText>
            </AppText>
